/**
 * ClipForge Dashboard — production.json validator.
 * EXACT port of bot/src/plan.js (itself paired with pipeline/plan/schema.py;
 * the cross-validation tests enforce identical accept/reject + error strings).
 * The Dashboard validates uploads itself — nothing calls into bot code.
