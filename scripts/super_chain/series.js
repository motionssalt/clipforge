/**
 * ClipForge Dashboard — Series Mode manual continuation helpers.
 * EXACT port of bot/src/series.js (pure derivation; all GitHub side effects
 * stay in the feature views). isValidJobId inlined from bot/src/jobs.js
 * (JOB_ID_RE = /^[A-Za-z0-9._-]+$/, JOB_ID_MAX_LEN = 120).
 */
